...
public class LoginActivity extends AppCompatActivity implements Content_Contract.View {
...
/*
    ...
    public void checkForLogin(){
        final loginRequest login = realm.where(loginRequest.class).findFirst();
        if (login!=null)
        {
            _emailText.setText(login.getEmail());
            _passwordText.setText(login.getPassword());
            login();
        }
    }
